...
COMMENT ON COLUMN public.benefit.project_id IS 'ID (see project.id) of the project to which this '
    'benefit belongs.';
COMMENT ON COLUMN public.benefit.beneficiary IS 'UUID of the user who is subject of this role '
...
COMMENT ON COLUMN public.profile.carbon_registry_link IS 'Link to a profile in the UN Carbon Registry '
