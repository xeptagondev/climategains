...
INSERT INTO public.profile (id, fullname, organization, ui_language, payment_accounts) VALUES
	('4153beed-984d-4108-bf43-c0f5617f44bd', 'Matthias Ansorg', 'Climate Gains', 'en', NULL),
	('545a051d-dd3a-4fdc-8a49-753d3466f57e', 'Test User 1', 'Test Organization', 'en', NULL);
...
INSERT INTO public.project (id, programme_id, name, created, updated, geo_lat, geo_long, location_name) OVERRIDING SYSTEM VALUE VALUES
...
SELECT pg_catalog.setval('public.medium_id_seq', 4, true);
SELECT pg_catalog.setval('public.programme_id_seq', 1, true);
SELECT pg_catalog.setval('public.project_id_seq', 1, true);
SELECT pg_catalog.setval('public.response_id_seq', 4, true);
SELECT pg_catalog.setval('public.programme_response_id_seq', 4, true);
SELECT pg_catalog.setval('public.role_id_seq', 4, true);
SELECT pg_catalog.setval('public.steps_id_seq', 1, true);
SELECT pg_catalog.setval('public.programme_step_id_seq', 2, true);
